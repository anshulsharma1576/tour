                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-chart-bar fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Frontend Signup Connection</p>
                                <?php
                                    $sql5="Select * from slider";
                                    $q5=mysqli_query($con, $sql5); 
                                    $count5=mysqli_num_rows($q5); 
                                ?>
                                <h6 class="mb-0"><?php echo $count5;?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Frontend Connection</h6>
                                <a href="">Show All</a> 
                            </div>
                            <h3>Account Signin with us</h3> 
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php
                                   include "loginquery.php";
                                   $sql4= "Select * from flog";
                                   $q4= mysqli_query($con,$sql4);
                                  
                                //    print_r($f);
                                  while( $f=mysqli_fetch_assoc($q4)){
                             ?>
                                <tr>
                                   
                                    <td><?php echo $f['id']; ?></td>
                                    <td><?php echo $f['name']; ?></td>
                                    <td> <?php echo $f['usermail']; ?></td>
...
<?php print_r($_SERVER);?>
                            ...
                            <p><?php echo $_SERVER['REQUEST_TIME_FLOAT']; ?></p>
